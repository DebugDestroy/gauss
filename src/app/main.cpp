...
3) Оптимизация
4) Инкапсуляция (просмотреть алгоритмы + библиотеки в файлах)


Изменения: Дал нормальные имена переменным в конфиге + добавил файлик с константами + улучшена инкапсуляция, изменил имя папки utilits на services, добавил новый файл .hpp
