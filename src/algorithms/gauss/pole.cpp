...
namespace algorithms::gauss {
    ...
    void Pole::logResizeOperation(int old_rows, int old_cols, int new_rows, int new_cols) const {
    ...
    Pole::Pole(int A, int B, core::Logger& lg) : logger(lg) {
